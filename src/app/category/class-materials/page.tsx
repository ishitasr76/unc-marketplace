            ...
            <div className="col-span-full text-center py-12">
              <div className="space-y-4">
                <div className="w-16 h-16 bg-muted rounded-full flex items-center justify-center mx-auto">
                  <span className="material-symbols-outlined text-muted-foreground text-2xl">book</span>
                </div>
                <h3 className="text-lg font-semibold text-foreground">No class materials found</h3>
                <p className="text-muted-foreground">Be the first to post class materials!</p>
              </div>
            </div>
          )}
        </div>
