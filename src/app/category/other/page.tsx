    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-6">
        <div className="space-y-4">
          <div className="w-16 h-16 bg-yellow-500 rounded-xl flex items-center justify-center mx-auto">
            <span className="material-symbols-outlined text-white text-2xl">home</span>
          </div>
          <h1 className="text-4xl font-bold text-foreground">Other</h1>
            ...
            <div className="col-span-full text-center py-12">
              <div className="space-y-4">
                <div className="w-16 h-16 bg-muted rounded-full flex items-center justify-center mx-auto">
                  <span className="material-symbols-outlined text-muted-foreground text-2xl">home</span>
                </div>
                        <h3 className="text-lg font-semibold text-foreground">No other items found</h3>
                <p className="text-muted-foreground">Be the first to post other items!</p>
              </div>
            </div>
          )}
        </div>
