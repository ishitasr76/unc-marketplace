    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-6">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-bold text-foreground">Dorm Stuff</h1>
            ...
            <div className="col-span-full text-center py-12">
              <div className="space-y-4">
                <div className="w-16 h-16 bg-muted rounded-full flex items-center justify-center mx-auto">
                  <span className="material-symbols-outlined text-muted-foreground text-2xl">bed</span>
                </div>
                <h3 className="text-lg font-semibold text-foreground">No dorm items found</h3>
                <p className="text-muted-foreground">Be the first to post a dorm item!</p>
              </div>
            </div>
          )}
        </div>
